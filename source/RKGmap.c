...
static // create cosine window. From: https://github.com/sidneycadot/WindowFunctions/blob/master/README.md
...
int RKGmapRun(RKMomentScratch *space, RKPulse **pulses, const uint16_t pulseCount) {
	...
	// compute clutter width
	// need beamwidth, angular velocity, elevation angle, and wavelength
	// float elevation = 0;
	// float angular_velocity = 15 * PI/180; // TODO: Where do I get this info?
	// float beamwidth = 3 * PI/180; // TODO: Where do I get this info?
	// float tx_frequency = 3e9; // TODO: Where do I get this info?
	// float wavelength = 3e8 / tx_frequency; // TODO: Where do I get this info?

...
CFLAGS = -g -std=gnu99 -march=native -mfpmath=sse -Os -Wall -Wno-unknown-pragmas -I headers -I /usr/local/include -I /usr/include -fPIC
LDFLAGS = -L /usr/local/lib
OBJS = RadarKit.o RKRadar.o RKFoundation.o RKMisc.o RKPulseCompression.o RKServer.o RKLocalCommandCenter.o RKSIMD.o RKTest.o
RKLIB = libRadarKit.a

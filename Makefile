...
OBJS = RadarKit.o RKRadar.o RKFoundation.o RKMisc.o RKPulseCompression.o RKServer.o RKLocalCommandCenter.o RKDSP.o RKSIMD.o RKMoment.o RKTest.o RKPulsePair.o
RKLIB = libRadarKit.a

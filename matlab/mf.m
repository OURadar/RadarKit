...
strideCollection = { ...
    ...
    [0, 1, 2], ... % hopCount = 3
    [0, 1, 2, 3], ... % hopCount = 4
    [0, 1, 2, 3, 4], ... % hopCount = 5
    [0, 1, 2, 3, 4, 5], ... % hopCount = 6
    [0, 2, 4, 6, 1, 3, 5], ... % hopCount = 7
    [0, 2, 4, 6, 0, 2, 4, 6], ... % hopCount = 8
    [0, 2, 4, 6, 8, 1, 3, 5, 7], ... % hopCount = 9
    [0, 2, 4, 6, 8, 0, 2, 4, 6, 8], ... % hopCount = 10
    [0, 3, 6, 9, 1, 4, 7, 10, 2, 5, 8], ... % hopCount = 11
    [0, 3, 6, 9, 0, 3, 6, 9, 0, 3, 6, 9], ... % hopCount = 12
    [0, 3, 6, 9, 12, 2, 5, 8, 11, 1, 4, 7, 10], ... % hopCount = 13
    };

...
static void showHelp(void) {
    ...
    *strrchr(name, '.') = '\0';
    printf("RadarKit Utility\n\n"
           ...
           "\n"
           "  -c (--core) " UNDERLINE("P,R,M") " (no space before or after ,)\n"
           "         Sets the number of threads for pulse compression to " UNDERLINE("P") ",\n"
           "         the number of threads for ring filter to " UNDERLINE("R") ", and\n"
           "         the number of threads for product generator to " UNDERLINE("M") ".\n"
           "         If not specified, the default core counts are 8,2,4.\n"
           "\n"
           "  -C (--show-clocks)\n"
